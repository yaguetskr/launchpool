...
const html_webpack_plugin_polyfill_1 = require("./html-webpack-plugin.polyfill");
    ...
    apply(compiler) {
        compiler.hooks.afterPlugins.tap(plugin_name_1.PLUGIN_NAME, () => {
            ...
            compiler.hooks.compilation.tap(plugin_name_1.PLUGIN_NAME, (compilation) => {
                ...
                const hook = html_webpack_plugin_polyfill_1.getAlterAssetTags(compilation);
                hook.tapPromise(`${plugin_name_1.PLUGIN_NAME} update asset tags`, (htmlPluginData) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    this.updateScriptTags(chunkMap, html_webpack_plugin_polyfill_1.getHeadTags(htmlPluginData));
                    this.updateScriptTags(chunkMap, html_webpack_plugin_polyfill_1.getBodyTags(htmlPluginData));
