...
export declare enum SafariNoModuleFixMode {
    external = "external",
    inline = "inline",
    inlineData = "inline-data",
    inlineDataBase64 = "inline-data-base64"
}
export declare enum SafariNoModuleFixInject {
    head = "head",
    body = "body"
}
...
export declare type SafariNoModuleFixOption = boolean | SafariNoModuleFixMode | SafariNoModuleFixOptionMap;
