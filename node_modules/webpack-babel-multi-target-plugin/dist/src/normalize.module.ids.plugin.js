    ...
    applyHtmlWebpackTagOrdering(compiler) {
        compiler.hooks.afterPlugins.tap(this.pluginName(), () => {
            ...
            compiler.hooks.compilation.tap(this.pluginName(), (compilation) => {
                ...
                hook.tapPromise(this.pluginName('reorder asset tags'), (htmlPluginData) => __awaiter(this, void 0, void 0, function* () {
                    const body = html_webpack_plugin_polyfill_1.getBodyTags(htmlPluginData);
                    ...
                    html_webpack_plugin_polyfill_1.setBodyTags(htmlPluginData, body);
